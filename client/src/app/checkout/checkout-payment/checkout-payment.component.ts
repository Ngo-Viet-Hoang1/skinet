...
import { IAddress } from '@app/shared/models/user';
...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe('pk_test_51QeuXSFytVyLTkSuBg9lieBVRmTHq0iQAMUZinvr4u9HPXWw6yeVO7K29AJOUUO8ctPnyunBW6uHPaLV0ayY80oc00aS0kdg7e').then(stripe => {
      this.stripe = stripe;
